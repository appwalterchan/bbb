...
import 'package:bbb/features/trip/controller/trip_controller.dart';
...
class EditTripPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final destinationController = useTextEditingController(text: trip.destination);
    final startDateController =
        useTextEditingController(text: DateFormat('yyyy-MM-dd').format(trip.startDate.getDateTime()));
    final endDateController =
        useTextEditingController(text: DateFormat('yyyy-MM-dd').format(trip.endDate.getDateTime()));
                    ...
                    onPressed: () async {
                      ...
                      if (currentState.validate()) {
                        final updatedTrip = trip.copyWith(
                          ...
                          startDate: TemporalDate(DateTime.parse(startDateController.text)),
                          endDate: TemporalDate(DateTime.parse(endDateController.text)),
                        );
