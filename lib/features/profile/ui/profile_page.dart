...
import 'package:bbb/features/profile/ui/edit_profile_bottomsheet.dart';
            ...
            children: [
              Card(
                child: ListTile(
                  ...
                  title: Text(
                    profile.firstName != null ? profile.firstName! : 'Add your name',
              ...
              Card(
                child: ListTile(
                  title: Text(
                    profile.firstName != null ? profile.homeCity! : 'Add your city',
                    style: Theme.of(context).textTheme.titleLarge,
                  ),
                ),
              ),
