...
final activityProvider = StreamProvider.autoDispose.family<Activity, String>((ref, activityId) {
  final activityProvider = ref.watch(activityControllerProvider);
  return activityProvider.listenToActivity(activityId);
});

final activityFutureProvider = FutureProvider.autoDispose.family<Activity, String>((ref, activityId) {
  final activityProvider = ref.watch(activityControllerProvider);
...
class ActivityController {
  ...
  Future<void> uploadFile(File file, Activity activity) async {
    ...
    if (fileKey != null) {
      ...
      final updatedActivity = activity.copyWith(activityImageKey: fileKey, activityImageUrl: imageUrl);
