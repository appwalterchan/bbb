...
import 'package:bbb/common/ui/upload_progress_dialog.dart';
...
import 'package:bbb/features/activity/ui/activity_category_icon.dart';
import 'package:bbb/features/activity/ui/activity_page/delete_activity_dialog.dart';
...
class ActivityPage extends ConsumerWidget {
  ...
  Future<bool> deleteActivity(BuildContext context, WidgetRef ref, Activity activity) async {
  ...
  Future<void> openFile({
    ...
    final fileUrl = await ref.read(activityControllerProvider).getFileUrl(activity);
        ...
        body: activityValue.when(
          data: (activity) => ListView(
            children: [
              Card(
                child: ListTile(
                  leading: ActivityCategoryIcon(activityCategory: activity.category),
                  title: Text(
              ...
              Card(
                child: ListTile(
                  title: Text(
                    DateFormat('EE MMMM dd').format(activity.activityDate.getDateTime()),
                    style: Theme.of(context).textTheme.titleLarge,
                  ),
                  subtitle: Text(DateFormat('hh:mm a').format(activity.activityTime!.getDateTime())),
                ),
              ),
              ListTile(
                dense: true,
