...
import 'package:bbb/features/activity/data/activities_repository.dart';
                        ...
                        oppositeContentsBuilder: (context, index) {
                          return InkWell(
                            ...
                            child: Padding(
                              ...
                              child: ActivityCategoryIcon(activityCategory: activities[index]!.category),
                            ),
                          );
                        },
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  DateFormat('yyyy-MM-dd').format(activities[index]!.activityDate.getDateTime()),
                                  style: Theme.of(context).textTheme.bodySmall,
                                ),
                                Text(
                                  DateFormat('hh:mm a').format(activities[index]!.activityTime!.getDateTime()),
                                  style: Theme.of(context).textTheme.bodySmall,
                                ),
                              ],
                            ),
